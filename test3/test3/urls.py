...
urlpatterns = [
    ...
    url(r'^hod/hod_vacancy/test/part2/inter_list/$', hod_inter_list),
    # url(r'^hod/hod_vacancy/test/part2/(\d+)/$', hod_inter_interviewer, name="inter2"),
    url(r'^hod/hod_vacancy/test/part2/(\d+)/(\d+)/$', hod_inter_interviewer_2, name="inter2"),
    url(r'^hod/hod_vacancy/test/part2/(\d+)/(\d+)/$', hod_inter_cv, name="inter2"),
    url(r'^hod/hod_vacancy/test/part2/(?P<vid>[0-9]+)/(?P<iid>[0-9]+)/(?P<pid>[0-9]+)/$', hod_inter_cv, name="inter2"),
